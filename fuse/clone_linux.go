...
var (
	...
	FUSE_DEV_IOC_CLONE = _IOR(229, 0, 4)
)
...
func cloneFuseConnection(sessionFd int) (int, error) {
	...
	// Turn the new fd into a worker fd as described at
	// https://john-millikin.com/the-fuse-protocol
	if err := unix.IoctlSetPointerInt(workerFd, FUSE_DEV_IOC_CLONE, sessionFd); err != nil {
		return 0, err
	}
